    ...
    public partial class frmFuncionario : Form
    {
        ...
        private void btnCriar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (MessageBox.Show("Confirma o cadastrado do funcionário " + (txtNome.Text)+" ?", "Menssagem do Sistema", MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) == DialogResult.OK)
                {
