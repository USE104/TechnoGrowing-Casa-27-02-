    ...
    public partial class frmLoja : Form
    {
        ...
        private void Produtos()
        {
            ...
            try
            {
                ...
                MessageBox.Show("Produto Cadastrado", "Mensagem do Sistema");
                limparCampos();
            }
            catch (Exception)
            {
                ...
                MessageBox.Show("Código de Funciário Inválido");
            }
            Conexao.fecharConexao();
        }
        private void btnCriar_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Confirma o cadastro dos produtos ?", "Mensagem do Sistema", MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) == DialogResult.OK)
            {
                MessageBox.Show("Produto cadastrado", "Mensagem do Sistema", MessageBoxButtons.OK, MessageBoxIcon.Information);
                Produtos();
                limparCampos();
            }
        ...
        private void rdbOculos_CheckedChanged(object sender, EventArgs e)
        {
            if (rdbOculos.Checked)
            {
                ...
                txtnomeProd.Text = ("Armação de Ocúlos");
            }
        }
