    ...
    public partial class frmVoluntariosONG : Form
    {
        ...
        private void btnCriar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MessageBox.Show("Confirmar o cadastramento do voluntario "+(txtNome.Text)+" ?", "Mensagem do Sistema", MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) == DialogResult.OK)
                {

                    MessageBox.Show(" O Voluntário "+(txtNome.Text)+ "cadastrado com sucesso", "Mensagem do Sistema");
                    LimparCampos();
                }
                else
                {
                    MessageBox.Show("você cancelou o cadastrado do voluntário "+txtNome.Text+" Mensagem do Sistema");
                }
